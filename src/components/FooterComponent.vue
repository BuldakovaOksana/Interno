<template>
    <footer class="footer center">
        <div class="footer__interno">
            <router-link class="footer__interno__logo" to="/"><img src="@/assets/img/Logo.png" alt="logo" />
                <p>Interno</p>
            </router-link>
            ...
            <div class="footer__interno__icons">
                <a class="footer__interno__icons-item" href="#">
        ...
        <div class="footer__pages">
            ...
            <router-link class="footer__pages__link" to="/">Home</router-link>
            <router-link class="footer__pages__link" to="/Project">Project</router-link>
            <router-link class="footer__pages__link" to="/Blog">Blog</router-link>
